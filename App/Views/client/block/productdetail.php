<?php var_dump($proallsizebycolor); ?>
<main class="ps-main">
  <div class="test">
    <div class="container">
      <div class="row">
    ...
    <div class="ps-container">
      <div class="row">
        <div class="col-lg-10 col-md-12 col-lg-offset-1">
          <div class="ps-product__thumbnail">
            <div class="ps-product__preview">
              <div class="ps-product__variants">
                <div class="item"><img src="\php-mvc-master\public\asset\images\shoe\<?php echo $productdetail[0]['title_cat'] ?>\<?php echo $productdetail[0]['title_subcat'] ?>\<?php echo $productdetail[0]['image'] ?>" alt=""></div>
            ...
            <div class="ps-product__image">
              <div class="item"><img class="zoom" src="\php-mvc-master\public\asset\images\shoe\<?php echo $productdetail[0]['title_cat'] ?>\<?php echo $productdetail[0]['title_subcat'] ?>\<?php echo $productdetail[0]['image'] ?>" alt="" data-zoom-image="\php-mvc-master\public\asset\images\shoe\<?php echo $productdetail[0]['title_cat'] ?>\<?php echo $productdetail[0]['title_subcat'] ?>\<?php echo $productdetail[0]['image'] ?>"></div>
          ...
          <form action="/php-mvc-master/public/productdetail/addtocart" method="POST">
            <div class="ps-product__info">
              ...
              <h1><?php echo $productdetail[0]['productname']; ?></h1>
              ...
              <div class="ps-product__block ps-product__quickview">
                <h4>QUICK REVIEW</h4>
                <p><?php echo $productdetail[0]['content'] ?></p>
              </div>
              <div class="ps-product__block ps-product__style">
                <h4>CHOOSE YOUR STYLE</h4>
                <ul>
                  <?php foreach ($productalldetail as $prode) { ?>
                    <li><a href="/php-mvc-master/public/productdetail/<?php echo $prode['id_prode']; ?>"><img src="\php-mvc-master\public\asset\images\shoe\<?php echo $productdetail[0]['title_cat'] ?>\<?php echo $productdetail[0]['title_subcat'] ?>\<?php echo $prode['image'] ?>" alt=""></a></li>
              ...
              <div class="ps-product__block ps-product__size">
                ...
                <select class="ps-select" name="sizetocart">
                  <option value="1">Select Size</option>
                  <?php foreach ($proallsizebycolor as $prosize) { ?>
                    <option value="<?php echo $prosize["size"]; ?>"><?php echo $prosize["size"]; ?></option>
                  <?php
                  }
                  ?>
                ...
                <div class="form-group">
                  <input class="form-control" type="number" value="1" name="quantitytocart">
                </div>
                <input type="hidden" value="<?php echo $productdetail[0]['id_pro']?>" name="idprotocart"/>
                <input type="hidden" value="<?php echo $productdetail[0]['color']?>" name="colortocart"/>
              </div>
              <div class="ps-product__shopping"><input type="submit" class="ps-btn mb-10" value="Add to cart" name="addtocart"><i class="ps-icon-next"></i></input>

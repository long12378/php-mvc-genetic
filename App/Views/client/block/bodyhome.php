    ...
    <div class="ps-container">
      <div class="ps-section__header mb-50">
        ...
        <ul class="ps-masonry__filter">
          ...
          <?php
          foreach ($variable as $cattitle) {
            echo '<li><a href="#" >' . $cattitle['title_cat'] . '<sup>1</sup></a></li>';
          }
          ?>
          <!-- <li><a href="#" >Nike <sup>1</sup></a></li><li><a href="#" >Nike <sup>1</sup></a></li>
              <li><a href="#" >Adidas <sup>1</sup></a></li>
              <li><a href="#" >Men <sup>1</sup></a></li>
              <li><a href="#" >Women <sup>1</sup></a></li>
              <li><a href="#" >Kids <sup>4</sup></a></li> -->
        </ul>
      </div>
      <div class="ps-section__content pb-50">
        <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
          <div class="ps-masonry row">
            ...
            <?php foreach ($allpro as $provalue) { ?>
              <div class="grid-item col-md-4 nike">
                <div class="grid-item__content-wrapper">
                  <div class="ps-shoe mb-30">
                    <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="\php-mvc-master\public\asset\images\shoe\<?php echo $provalue['title_cat']?>\<?php echo $provalue['title_subcat']?>\<?php echo $provalue['image']?>" alt=""><a class="ps-shoe__overlay" href="/php-mvc-master/public/productdetail/<?php echo $provalue['id_prode']; ?>"></a>
                    </div>
                    <div class="ps-shoe__content">
                      ...
                      <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#"><?php echo $provalue['productname'] ?></a>
                        <p class="ps-shoe__categories"><a href="#"><?php echo $provalue['image']?></a>,<a href="#"> <?php echo $provalue['title_cat']?></a>,<a href="#"> <?php echo $provalue['title_subcat']?></a></p><span class="ps-shoe__price"><?php echo $provalue['price'] ?> đ</span>
                      </div>
                    </div>
                  </div>
                </div>
